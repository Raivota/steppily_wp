            ...
            if (rtTPG()->verifyNonce()) {
                ...
                if (!empty($filters) && ($isGrid || $isOffset || $isWooCom)) {
                    ...
                    if (in_array('_search', $filters)) {
                        ...
                        $data .= sprintf('<input type="text" class="rt-search-input" placeholder="%s">', esc_html__("Search...", 'the-post-grid-pro'));
                ...
                if ($gridQuery->have_posts()) {
                    ...
                    $not_found_text = isset($scMeta['tgp_not_found_text']) && !empty($scMeta['tgp_not_found_text']) ? esc_attr($scMeta['tgp_not_found_text']) : __('No post found', 'the-post-grid-pro');
