    ...
    */
    class RT_TPGWidget extends WP_Widget
    {
        ...
        function __construct() {
            ...
            $widget_ops = array( 'classname' => 'widget_tpg_post_grid', 'description' => __('Display the post grid.', 'the-post-grid-pro') );
            parent::__construct( 'widget_tpg_post_grid', __('The Post Grid Pro', 'the-post-grid-pro'), $widget_ops);
        ...
        function form( $instance ) {
            ...
            $defaults = array(
                'title' => "The Post Grid Pro",
                'id' => null
            );
            $instance = wp_parse_args( (array) $instance, $defaults ); ?>

            <p><label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:',
                        'the-post-grid-pro' ); ?></label>
