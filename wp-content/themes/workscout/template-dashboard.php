    ...
    ================================================== -->
                    ...
                    <div class="dashboard-nav <?php echo esc_attr($role); ?>-dashboard-nav">
                        <div class="dashboard-nav-inner">
                            ...
                            <?php if ( class_exists('WorkScout_Freelancer') && in_array($role, array('administrator', 'admin', 'employer'))) : ?>
                                <ul id="task-menu" data-submenu-title="<?php esc_html_e('Tasks', 'workscout'); ?>">
                                    ...
                                    <?php endif; ?>
                                    <?php $task_bidders = get_option('workscout_freelancer_manage_bidders_page_id');
                                    if ($task_bidders) : ?>
                                        <li id="task_bidderss-menu" <?php if ($post->ID == $task_bidders) : ?>class="active" <?php endif; ?>>
                                            <a href="<?php echo esc_url(get_permalink($task_bidders)); ?>">
                                                <?php echo get_the_title($task_bidders); ?>
                                            </a>
                                        </li>
                                    <?php endif; ?>
                                    <?php $task_my_bids = get_option('workscout_freelancer_manage_my_bids_page_id');
                                    if ($task_my_bids) : ?>
                                        <li id="task_my_bids-menu" <?php if ($post->ID == $task_my_bids) : ?>class="active" <?php endif; ?>>
                                            <a href="<?php echo esc_url(get_permalink($task_my_bids)); ?>">
                                                <?php echo get_the_title($task_my_bids); ?>
                                            </a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            ...
                            <?php if (in_array($role, array('administrator', 'admin', 'employer'))) : ?>
                                <ul id="employer-menu" data-submenu-title="<?php esc_html_e('Employer', 'workscout'); ?>">
                                    ...
                                    $submit_comapny = get_option('job_manager_submit_company_form_page_id');
                                    if ($submit_comapny) : ?>
                                        <li id="submit_page-menu" <?php if ($post->ID == $submit_comapny) : ?>class="active" <?php endif; ?>>
                                            <a href="<?php echo esc_url(get_permalink($submit_comapny)); ?>">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyrights"> <?php $copyrights = Kirki::get_option('workscout', 'pp_copyrights');
                                                            echo wp_kses($copyrights, array('a' => array('href' => array(), 'title' => array()), 'br' => array(), 'em' => array(), 'strong' => array(),)); ?></div>
                            </div>
                        </div>
